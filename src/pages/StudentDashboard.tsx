...
import { User, Phone, BookOpen, DollarSign, FileText, Bell, AlertTriangle, CheckCircle, XCircle, BarChart3, RefreshCw, GraduationCap, LogOut } from 'lucide-react';
...
export default function StudentDashboard({ token, studentInfo, onLogout }: StudentDashboardProps) {
